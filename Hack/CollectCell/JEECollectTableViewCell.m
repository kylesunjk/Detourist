...
- (void)hiddeSupplierViewAnimation
{
    [UIView animateWithDuration:0.5 animations:^{
        [_collectView setFrame:CGRectMake([UIScreen mainScreen].bounds.size.width - [UIScreen mainScreen].bounds.size.width, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height)];
